...
.. figure:: img/skb501_nrf52840.png
     :width: 442px
     :align: center
     :alt: nRF52840 DK
...
The skb501_nrf52840 board configuration supports the following
hardware features:
...
Applications for the ``skb501_nrf52840`` board configuration can be
...
:zephyr_file:`boards/arm/skb501_nrf52840/skb501_nrf52840.dts`.
