...
/* The devicetree node identifier for the "pumpdrain" alias.*/
#define PUMPDRAIN_NODE DT_ALIAS(pumpdrain)

#if DT_NODE_HAS_STATUS(PUMPDRAIN_NODE, okay)
#define PUMPDRAIN	DT_GPIO_LABEL(PUMPDRAIN_NODE, gpios)
#define PIN_PUMPDRAIN	DT_GPIO_PIN(PUMPDRAIN_NODE, gpios)
#if DT_PHA_HAS_CELL(PUMPDRAIN_NODE, gpios, flags)
#define FLAGS_PUMPDRAIN	DT_GPIO_FLAGS(PUMPDRAIN_NODE, gpios)
#endif
#else
/* A build error here means your board isn't set up to blink an LED. */
#error "Unsupported board: pumpdrain devicetree alias is not defined"
#define PUMPDRAIN	""
#define PIN_PUMPDRAIN	0
#endif

#ifndef FLAGS_PUMPDRAIN
#define FLAGS_PUMPDRAIN	0
#endif

/* The devicetree node identifier for the "valvesdrain" alias.*/
#define VALVESDRAIN_NODE DT_ALIAS(valvesdrain)

#if DT_NODE_HAS_STATUS(VALVESDRAIN_NODE, okay)
#define VALVESDRAIN	DT_GPIO_LABEL(VALVESDRAIN_NODE, gpios)
#define PIN_VALVESDRAIN	DT_GPIO_PIN(VALVESDRAIN_NODE, gpios)
#if DT_PHA_HAS_CELL(VALVESDRAIN_NODE, gpios, flags)
#define FLAGS_VALVESDRAIN	DT_GPIO_FLAGS(VALVESDRAIN_NODE, gpios)
#endif
#else
/* A build error here means your board isn't set up to blink an LED. */
#error "Unsupported board: valvesdrain devicetree alias is not defined"
#define VALVESDRAIN	""
#define PIN_VALVESDRAIN	0
#endif

#ifndef FLAGS_VALVESDRAIN
#define FLAGS_VALVESDRAIN	0
#endif
...
/**
* Set the PUMPDRAIN State
*
* @param State to set the PUMPDRAIN to (0/1)
*/
void bm_pumpdrain_set(bool state);

/**
* Get the PUMPDRAIN State
*
* @return State of the PUMPDRAIN (0/1)
*/
bool bm_pumpdrain_get();

/**
* Set the VALVESDRAIN State
*
* @param State to set the VALVESDRAIN to (0/1)
*/
void bm_valvesdrain_set(bool state);

/**
* Get the VALVESDRAIN State
*
* @return State of the VALVESDRAIN (0/1)
*/
bool bm_valvesdrain_get();
