...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NRFX_COMP, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LORA_LOG_LEVEL_INF, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CONSOLE_GETCHAR_BUFSIZE, 1024);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_CONSOLE_PUTCHAR_BUFSIZE, 1024);
