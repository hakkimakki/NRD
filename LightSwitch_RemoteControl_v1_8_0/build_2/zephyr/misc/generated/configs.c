...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SDC_SCAN_BUFFER_COUNT, 3);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_MESH_PROXY_FILTER_SIZE, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_MESH_LPN_AUTO, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_MESH_LPN_AUTO_TIMEOUT, 5);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_MESH_LPN_POLL_TIMEOUT, 3600);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BT_MESH_LPN_INIT_POLL_TIMEOUT, 3600);
