 ...
 *(.ARM.exidx* gnu.linkonce.armexidx.*)
 ...
 bt_mesh_subnet_cb_area : SUBALIGN(4) { _bt_mesh_subnet_cb_list_start = .; KEEP(*(SORT(._bt_mesh_subnet_cb.static.*))); _bt_mesh_subnet_cb_list_end = .; } > FLASH
 bt_mesh_app_key_cb_area : SUBALIGN(4) { _bt_mesh_app_key_cb_list_start = .; KEEP(*(SORT(._bt_mesh_app_key_cb.static.*))); _bt_mesh_app_key_cb_list_end = .; } > FLASH
 bt_mesh_hb_cb_area : SUBALIGN(4) { _bt_mesh_hb_cb_list_start = .; KEEP(*(SORT(._bt_mesh_hb_cb.static.*))); _bt_mesh_hb_cb_list_end = .; } > FLASH
 bt_mesh_friend_cb_area : SUBALIGN(4) { _bt_mesh_friend_cb_list_start = .; KEEP(*(SORT(._bt_mesh_friend_cb.static.*))); _bt_mesh_friend_cb_list_end = .; } > FLASH
...
bt_mesh_sensor_types_sections : ALIGN_WITH_INPUT SUBALIGN(4)
{
 ...
 KEEP(*(SORT("._bt_mesh_sensor_type.static.*")));
